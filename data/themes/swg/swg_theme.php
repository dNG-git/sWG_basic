...
$g_continue_check = ((defined ("CLASS_direct_oxhtml_theme")) ? false : true);
...
*             W3C (R) Software License
*/
class direct_oxhtml_theme extends direct_output_inline
{
/* -------------------------------------------------------------------------
Extend the class using old and new behavior
------------------------------------------------------------------------- */

	//f// direct_oxhtml_theme->__construct () and direct_oxhtml_theme->direct_oxhtml_theme ()
/**
	* Constructor (PHP5) __construct (direct_oxhtml_theme)
	*
	* @uses  direct_debug()
...
*/
	/*#ifndef(PHP4) */public /* #*/function __construct ()
	{
		...
		if (USE_debug_reporting) { direct_debug (5,"sWG/#echo(__FILEPATH__)# -output_theme_class->__construct (direct_oxhtml_theme)- (#echo(__LINE__)#)"); }
...
/*#ifdef(PHP4):
/**
	* Constructor (PHP4) direct_oxhtml_theme (direct_oxhtml_theme)
	*
	* @since v0.1.00
*\/
	function direct_oxhtml_theme () { $this->__construct (); }
:#*/
	//f// direct_oxhtml_theme->theme_page ($f_title)
/**
...
<td class='designpagebg' style='padding:10px 12px;text-align:left;vertical-align:middle'>");
		...
		if ($direct_globals['output']->options_check ("servicemenu")) { $this->output_data .= "<p class='pageborder2{$direct_settings['theme_css_corners']} pageextracontent' style='text-align:left'>".($direct_globals['output']->options_generator ("h","servicemenu"))."</p>\n"; }
...
$direct_globals['@names']['output_theme'] = "direct_oxhtml_theme";
define ("CLASS_direct_oxhtml_theme",true);
}
