...
jQuery(function ()
{
	jQuery(self.document).pngFix ({ blankgif:'".(direct_linker_dynamic ("url0","s=cache;dsd=dfile+$direct_settings[path_mmedia]/ext_jquery/jquery.pngFix.gif",true,false))."' })
		...
		$direct_globals['output']->headerElements ("<link href='$direct_settings[path_mmedia]/ext_jquery/themes/$direct_settings[theme_jquery_ui]/jquery-ui-1.8.21.css' rel='stylesheet' type='text/css' />","link_stylesheet_jquery_ui");
