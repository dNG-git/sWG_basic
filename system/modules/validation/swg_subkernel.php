...
----------------------------------------------------------------------------
$Id: swg_subkernel.php,v 1.2 2008/12/20 13:38:08 s4u Exp $
...
$direct_classes['@names']['subkernel_validation'] = "direct_subkernel_validation";
define ("CLASS_direct_subkernel_validation",true);

//j// Script specific commands

direct_class_init ("subkernel_validation");
$direct_classes['kernel']->v_call_set ("v_subkernel_init",$direct_classes['subkernel_validation'],"subkernel_init");
}
