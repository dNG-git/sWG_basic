...
case "services":
{
	...
	{
	//j// BOA
	$direct_globals['output']->related_manager ("developer_index_services","pre_module_service_action");
	...
	$direct_globals['output']->related_manager ("developer_index_services","post_module_service_action");
	$direct_globals['output']->oset ("default","service_list");
	$direct_globals['output']->output_send (direct_local_get ("core_service_list"));
	//j// EOA
	}
