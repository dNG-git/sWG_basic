...
----------------------------------------------------------------------------
$Id: swg_index.php,v 1.2 2008/12/20 13:36:15 s4u Exp $
...
case "services":
{
	...
	{
	//j// BOA
	direct_output_related_manager ("developer_index_services","pre_module_service_action");
	...
	if (($g_task_array)&&(isset ($g_task_array['core_filter_developer_services']))&&($g_task_array['uuid'] == $direct_settings['uuid']))
	{
		$direct_cachedata['output_filter_text'] = $direct_classes['formtags']->decode ($g_task_array['core_filter_developer_services']);
	...
	direct_output_related_manager ("developer_index_services","post_module_service_action");
	...
	$direct_classes['output']->page_show (direct_local_get ("core_service_list"));
	//j// EOA
	}
