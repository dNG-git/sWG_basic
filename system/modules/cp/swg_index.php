...
case "services":
{
	...
	{
	//j// BOA
	$direct_globals['output']->relatedManager ("cp_index_services","pre_module_service_action");
	...
	$direct_globals['output']->relatedManager ("cp_index_services","post_module_service_action");
	$direct_globals['output']->oset ("default","service_list");
	$direct_globals['output']->outputSend (direct_local_get ("cp_core_control_panel"));
	//j// EOA
	}
